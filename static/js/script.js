...
function select(isGuessedTrue) {
    ...
    return isGuessedTrue ? playerGuessArray.push('true') : playerGuessArray.push('false');
}
...
// fisher-yates shuffle algorithm to shuffle the equations array
...
function countdownStart() {
    let count = 3;
    const timeCountDown = countdown.textContent = count;
    setInterval(() => {
        count--;
        if (count === 0){
